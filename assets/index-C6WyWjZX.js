(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`uk`,t={uk:{handMade:`Ручна робота`,title:`В’язані вироби ручної роботи`,subtitle:`Пледи, іграшки та інші handmade-вироби`,viewProducts:`Переглянути`,order:`Замовити`,productsTitle:`Наші вироби`,blankets:`Пледи`,blanketsText:`Теплі і затишні`,toys:`Іграшки`,toysText:`М’які handmade`,other:`Інші вироби`,otherText:`Під замовлення`,galleryTitle:`Галерея`,contactsTitle:`Контакти`,phone:`Телефон`,telegram:`Telegram`,instagram:`Instagram`,callBtn:`Подзвонити`,langBtn:`English`},en:{handMade:`Handmade`,title:`Handmade knitted products`,subtitle:`Blankets, toys and other handmade items`,viewProducts:`View products`,order:`Order now`,productsTitle:`Our products`,blankets:`Blankets`,blanketsText:`Warm and cozy`,toys:`Toys`,toysText:`Soft handmade`,other:`Other products`,otherText:`Made to order`,galleryTitle:`Gallery`,contactsTitle:`Contacts`,phone:`Phone`,telegram:`Telegram`,instagram:`Instagram`,callBtn:`Call now`,langBtn:`Українська`}};function n(){let e=document.querySelectorAll(`.reveal`),t=new IntersectionObserver(e=>{e.forEach(e=>{let t=e.intersectionRatio;t>=.5?e.target.classList.add(`show`):t<.2&&e.target.classList.remove(`show`)})},{threshold:[0,.2,.5,.8,1]});e.forEach(e=>t.observe(e))}function r(){let i=t[e];document.querySelector(`#app`).innerHTML=`
    ...
    >
      ...
      <section id="products" class="px-6 py-16 md:px-12 lg:px-20">
        <div class="max-w-6xl mx-auto">
          <h2 class="section-title text-3xl text-center mb-10 reveal reveal-up">${i.productsTitle}</h2>
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white text-black rounded-3xl p-5 shadow-xl reveal reveal-up">
              ...
              <h3 class="text-xl font-semibold">${i.blankets}</h3>
              <p class="mb-4">${i.blanketsText}</p>
              <a href="#contacts" class="bg-black text-white px-4 py-2 rounded-xl inline-block">${i.order}</a>
            </div>
            ...
            <div class="bg-white text-black rounded-3xl p-5 shadow-xl reveal reveal-zoom">
              ...
              <h3 class="text-xl font-semibold">${i.toys}</h3>
              <p class="mb-4">${i.toysText}</p>
              <a href="#contacts" class="bg-black text-white px-4 py-2 rounded-xl inline-block">${i.order}</a>
            </div>
            ...
            <div class="bg-white text-black rounded-3xl p-5 shadow-xl reveal reveal-right">
              ...
              <h3 class="text-xl font-semibold">${i.other}</h3>
              <p class="mb-4">${i.otherText}</p>
              <a href="#contacts" class="bg-black text-white px-4 py-2 rounded-xl inline-block">${i.order}</a>
            </div>
          </div>
        </div>
      ...
      <section class="px-6 py-16 md:px-12 lg:px-20">
        <div class="max-w-6xl mx-auto">
          <h2 class="section-title text-3xl text-center mb-10 reveal reveal-up">${i.galleryTitle}</h2>
      ...
      <section id="contacts" class="px-6 py-16 text-center">
        <div class="reveal reveal-contact">
          <h2 class="section-title text-3xl mb-6">${i.contactsTitle}</h2>

          <p class="mb-2">${i.phone}: +38082063627</p>
          <p class="mb-2">${i.telegram}: +38082063627</p>
          <p class="mb-4">${i.instagram}: @tanya_mukhajlenko</p>
  ...
  `,document.querySelector(`#lang-toggle`).addEventListener(`click`,()=>{e=e===`uk`?`en`:`uk`,r()}),n();let a=document.querySelector(`#loader`);setTimeout(()=>{a.classList.add(`loader-hide`)},1200)}r();